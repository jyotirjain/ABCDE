...
function Eic() {
  ...
  const handlesubmit = () => {
    const calculatedNumberOfShares = input1 / input2;
    setresult1(calculatedNumberOfShares);
  };
  ...
  return (
    <div>
      ...
      <Helmet defer={false}>
        ...
        <meta
          name="description"
          title="Equity Investment Calculator - Calculate Your Potential Returns | Bizdateup"
          content=" With the Equity Investment Calculator from Bizdateup, you can easily calculate your potential returns on equity investments. Get started today and see how much your investments can grow!"
        />
      </Helmet>
      <div className="flex justify-center bg-[#fafafa] p-4 md:p-8">
        <div className="w-[100%] md:max-w-[1350px] 2xl:w-[65%]">
          ...
          <div className="flex justify-between gap-6">
            <div className="profile-container w-full md:w-[75%] flex flex-col gap-4">
              <h2 className="not-italic font-normal text-xl leading-[23px] text-[#202054] font-[Inter]">
                Calculate Your Equity Investment Online
              </h2>
          ...
          <div className="border shadow-[0px_1px_12px_rgba(0,0,0,0.15)] rounded-[10px] border-solid flex flex-col gap-3 border-[#DDDDDD] bg-[#ffffff] my-6 p-8">
            ...
            <h2 className="not-italic font-normal text-xl leading-[23px] text-[#202054] font-[Inter]">
              Calculate Your Returns on Equity Investments with Ease
            </h2>
            <p className="not-italic font-normal text-[16px] leading-6 text-[#828F99] font-[Inter]">
              If you're looking to invest in equity, you need to know what
              returns you can expect. That's where the Equity Investment
              Calculator from Bizdateup comes in. Our tool allows you to easily
              calculate your potential returns based on your investment amount,
              expected return rate, and investment period.
              <br />
              To use the Equity Investment Calculator, simply enter your
              investment amount, expected return rate, and investment period.
              Our tool will then calculate your potential returns and display
              them for you in an easy-to-understand format.
              <br />
              With our Equity Investment Calculator, you can quickly and easily
              determine the potential returns on your equity investments. This
              makes it easy for you to make informed investment decisions and
              ...
              including our Equity Investment Calculator. With our platform, you
              can invest in a diverse range of startups with ease, and grow your
              ...
              <br />
              Closing Paragraph: If you're interested in equity investments, the
              Equity Investment Calculator from Bizdateup is the perfect tool
              for you. With our platform, you can invest in a diverse range of
              startups with ease, and grow your portfolio quickly and
              efficiently. Sign up today and start investing in the future!
            </p>
          </div>
        </div>
      </div>
