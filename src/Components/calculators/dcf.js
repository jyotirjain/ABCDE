...
function Dcf() {
  ...
  const handlesubmit = () => {
    const valuation = input1 / (input3 - input2);
  ...
  return (
    <div>
      ...
      <Helmet defer={false}>
        <title>
          Valuation from Discounted Cash Flow (DCF) Method Calculator -
          Calculate Company's Worth
        </title>
        <meta
          name="description"
          content="Use our Valuation from Discounted Cash Flow (DCF) Method Calculator to calculate your company's worth. Get accurate results with our easy-to-use DCF valuation tool."
        />
      </Helmet>
      <div className="flex justify-center bg-[#fafafa] p-4 md:p-8">
        <div className="w-[100%] md:max-w-[1350px] 2xl:w-[65%]">
          ...
          <div className="flex justify-center gap-6">
            <div className="profile-container w-full md:w-[75%] flex flex-col gap-4">
              <h2 className="not-italic font-normal text-xl leading-[23px] text-[#202054] font-[Inter]">
                Calculate Your Discounted Cash flow Online
              </h2>
          ...
          <div className="border shadow-[0px_1px_12px_rgba(0,0,0,0.15)] rounded-[10px] border-solid flex flex-col gap-3 border-[#DDDDDD] bg-[#ffffff] my-6 p-8">
            ...
            <h2 className="not-italic font-normal text-xl leading-[23px] text-[#202054] font-[Inter]">
              Calculate your company's worth accurately with our DCF valuation
              tool
            </h2>
            <p className="not-italic font-normal text-[16px] leading-6 text-[#828F99] font-[Inter]">
              Are you looking to calculate the true value of your company? The
              discounted cash flow (DCF) method is a popular valuation method
              used to determine the worth of a company. This method takes into
              account the expected cash flows of a company in the future and
              discounts them back to their present value. The resulting figure
              is the net present value (NPV) of the company, which can be used
              to determine the value of the company as a whole or its individual
              equity.
              <br />
              With our Valuation from Discounted Cash Flow (DCF) Method
              Calculator, you can easily calculate your company's worth. Simply
              enter the expected cash flows, discount rate, and other relevant
              information into the calculator, and let our tool do the rest. Our
              calculator uses the latest industry-standard formulas and
              algorithms to give you the most accurate valuation possible.
              <br />
              Using our DCF valuation tool is easy, and can be used by anyone
              looking to value their company. Whether you're a startup founder,
              investor, or business owner, our tool can provide you with the
              necessary information to make informed decisions about your
              business.
              <br />
              At Bizdateup, we understand the importance of accurate valuations
              in making investment decisions. That's why we offer a wide range
              of investment tools, including our Valuation from Discounted Cash
              Flow (DCF) Method Calculator. With our platform, you can invest in
