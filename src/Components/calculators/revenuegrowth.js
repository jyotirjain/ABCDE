...
function Revenuegrowth() {
  ...
  const handlesubmit = () => {
    const estimated = input1 * Math.pow(1 + input2 / 100, input3);
  ...
  return (
    <div>
      ...
      <Helmet defer={false}>
        <title>
          Revenue Growth Calculator - Calculate Your Business Growth Potential
        </title>
        <meta
          name="description"
          content="Use our Revenue Growth Calculator to determine your business's revenue growth potential based on your current and projected revenue."
        />
      </Helmet>
        ...
        <div className="w-[100%] md:max-w-[1350px] 2xl:w-[65%]">
          ...
          <div className="flex justify-between gap-6">
            <div className="profile-container w-full md:w-[75%] flex flex-col gap-4">
              <h2 className="not-italic font-normal text-xl leading-[23px] text-[#202054] font-[Inter]">
                Calculate Your Revenue Growth Online
              </h2>
          ...
          <div className="border shadow-[0px_1px_12px_rgba(0,0,0,0.15)] rounded-[10px] border-solid flex flex-col gap-3 border-[#DDDDDD] bg-[#ffffff] my-6 p-8">
            ...
            <p className="not-italic font-normal text-[16px] leading-6 text-[#828F99] font-[Inter]">
              Are you curious about your business's growth potential? Our
              Revenue Growth Calculator can help! This tool allows you to
              project your business's revenue growth based on your current
              revenue and projected growth rate.
              <br />
              To use the calculator, simply input your current revenue and
              projected growth rate, and the tool will calculate your business's
              potential revenue growth over the selected time period. This can
              help you make more informed decisions about your business strategy
              and future investments.
              <br />
              At [Company Name], we understand the importance of accurate
              revenue projections and strategic planning for your business's
              success. That's why we offer this free tool to help you make
              informed decisions about your business's growth potential.
              <br />
              So why wait? Try our Revenue Growth Calculator today to see how
              your business can grow and thrive in the future!
              <br />
              Closing Paragraph:
              <br />
              Don't let your business's growth potential go to waste. At
              [Company Name], we offer a range of investment opportunities that
              can help you take your business to the next level. Whether you're
              looking to invest in a new startup or diversify your portfolio,
              our platform makes it easy to invest in the future of your
              business. Sign up today and start building a high-return portfolio
              with low risk!
            </p>
          </div>
        </div>
