...
import point from "../../assets/images/bizzneeti/point.png";
    ...
    >
      <div className="bg-[#4C1145] max-w-[1280px] w-full px-[20px] py-[40px] rounded-[15px] flex flex-col items-center justify-center ">
        ...
        <div className="w-full max-w-[800px] flex flex-col gap-10 relative mt-8">
          ...
          <div className=" h-[95%] md:h-[1300px] pointline w-[4px] bg-black absolute top-[-10px] md:left-[50%] left-[14px] md:right-auto  bottom-auto md:-translate-x-2/4   ">
